using BookACar.Dto.AuthorDtos;
using BookACar.Dto.TagCloudDtos;
...
namespace BookACar.WebUI.ViewComponents.BlogViewComponents
{
    public class _BlogDetailsAuthorAboutComponentPartial:ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync(int id)
        {
            ...
            var responseMessage = await client.GetAsync($"https://localhost:7273/api/Blogs/GetAuthorByBlogIdList?id=" + id);
